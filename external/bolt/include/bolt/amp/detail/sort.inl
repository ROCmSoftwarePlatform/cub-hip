			 ...
			 )
{
	...
	static constexpr unsigned int localSize  = WG_SIZE;
...
template<typename RandomAccessIterator,
         typename std::enable_if<sizeof(typename std::iterator_traits<RandomAccessIterator>::value_type) % sizeof(int) == 0>::type* = nullptr>
static
inline
